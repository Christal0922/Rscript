...
pdf("E:/R/Morpho2/20210713_Vlin.pdf",width = 4.5,height = 3.8)
for (i in 1:(length(T_merge)-3)){
  p1 <- ggplot(T_merge,aes(x=group,y=T_merge[,(i+3)]))+
...
pdf("E:/R/Morpho2/20210726_Cortical.pdf",width = 4.5,height = 4.6)
for (i in 1:(length(T_merge)-3)){
